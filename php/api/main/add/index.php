...
<body>
    ...
    ?>
        ...
        echo '<p class="title">Client Token:</p><textarea rows="9" readonly>' . clean_data($_GET['client_token']) . '</textarea><button onclick="console.log(window.location.pathname); console.log(window.location); var url = window.location.pathname; window.location = url;"><span class="state">Back</span></button>';
    } ?>
        </form>
    </div>
