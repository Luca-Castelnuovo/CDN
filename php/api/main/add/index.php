...
<body>
    ...
    ?>
        ...
        echo '<p class="title">Client Token:</p><textarea rows="9" cols="13" readonly>' . clean_data($_GET['client_token']) . '</textarea><button onclick="window.location.replace(\"index.php\")"><span class="state">Back</span></button>';
    } ?>
        </form>
    </div>
