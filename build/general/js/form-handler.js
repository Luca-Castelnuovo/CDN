...
if(function(){if(s.honeypot)//if hidden form filled up
...
var i=r.querySelector(".email-invalid");if(i)return!(i.style.display="block")}else{!function(){for(var e=r.querySelectorAll("button"),t=0;t<e.length;t++)e[t].disabled=!0}();var c=r.action,u=new XMLHttpRequest;u.open("POST",c),// xhr.withCredentials = true;
