...
function auth_get_access_token($client_id, $client_secret, $code, $provided_state) {
    ...
    $access_token_request = auth_request('https://accounts.lucacastelnuovo.nl/auth/token', ["client_id" => "{$client_id}", "client_secret" => "{$client_secret}", "code" => "{$code}", "state" => "{$provided_state}", "grant_type" => "authorization_code"]);
