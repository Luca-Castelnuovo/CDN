        ...
        follower.username
                        ...
                        <a onclick="${
                          follower.is_following
                            ? `user_follow('${follower.username}')`
                            : `user_undo_follow('${follower.username}')`
                        }" class="waves-effect btn right ${
        follower.is_following
          ? `grey lighten-5 black-text tooltipped" data-position="right" data-tooltip="Unfollow`
          : 'waves-light blue accent-4 "'
      }">${follower.is_following ? "Following" : "Follow"}</a>
                    </div>
                </li>
            `;
        ...
        following.username
                        ...
                        <a onclick="${
                          following.is_following
                            ...
                            : `user_undo_follow('${following.username}')`
                        }" class="waves-effect btn right ${
        following.is_following
          ? `grey lighten-5 black-text tooltipped" data-position="right" data-tooltip="Unfollow`
          : 'waves-light blue accent-4 "'
